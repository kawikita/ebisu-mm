...
CREATE TRIGGER update_entries_updated_at AFTER
UPDATE ON entries FOR EACH ROW BEGIN
UPDATE entries
SET
    updated_at = CURRENT_TIMESTAMP
WHERE
...
CREATE TRIGGER update_credit_card_installments_updated_at AFTER
UPDATE ON credit_card_installments FOR EACH ROW BEGIN
...
CREATE TRIGGER update_credit_card_revolving_history_updated_at AFTER
UPDATE ON credit_card_revolving_history FOR EACH ROW BEGIN
UPDATE credit_card_revolving_history
SET
    updated_at = CURRENT_TIMESTAMP
WHERE
    revolving_history_id = NEW.revolving_history_id;
